...
func (t DefaultController) GetSingleAlert(w http.ResponseWriter, r *http.Request) {
	...
	resp, err := t.alertService.GetSingleAlert(token, orgId, envId, productId, alertId)
